...
The site is generated using the script `mksite` which takes a markdown document
and converts it into HTML and does some fancy shamcy things to make a minimal
site. 
